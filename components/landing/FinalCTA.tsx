  ...
  return (
    <section id="waitlist" className="relative py-40 px-8 bg-truth-nearBlack text-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        >
          Radical Honesty.<br />
          <span className="text-truth-accentRed block">Absolute Privacy.</span>
        </motion.h2>
        ...
        >
          Your truth is a signal. Don&apos;t let it fade.<br />
          Join the decentralized movement for human authenticity.
        </motion.p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-wrap gap-4 max-w-2xl mx-auto justify-center mb-8">
          ...
          <button
            type="submit"
            className="px-12 py-6 bg-truth-accentRed text-truth-bg font-mono font-bold uppercase tracking-widest hover:bg-white hover:scale-105 transition-all duration-300"
          >
            SYNC_NODE_ACCESS
          </button>
        </form>
